...
cogent.isrunning = 'YES'; % added by DL to put in a "is running" flag into cogent. This will be set to "NO" in the stop_cogent routine. Updated 1/Feb/2009
...
if isfield( cogent, 'display' )
    ...
    % cgopen( cogent.display.res, cogent.display.nbpp, 0, cogent.display.mode ); % replaced David Lloyd 23/3/2010
    % cgopen( cogent.display.size(1), cogent.display.size(2), cogent.display.nbpp, 0, cogent.display.mode ); % added David Lloyd 23/3/2010
