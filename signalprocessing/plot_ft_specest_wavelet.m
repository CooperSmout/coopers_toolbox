function [spectrum,freqoi,timeoi] = plot_ft_specest_wavelet(dat, time, varargin)
...
%     end
    ...
    % PLOT WAVELET (CS, adapted from Cohen ch.13)
    hold on;
    hz = linspace(0,fsample/2,(length(wavelet)-1)/2);
    fftW  = fft(wavelet);
    plot(hz,abs(fftW(1:length(hz))))
